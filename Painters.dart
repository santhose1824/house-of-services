...
class PainterValidate extends StatefulWidget {
  const PainterValidate({Key? key}) : super(key: key);

  @override
  State<PainterValidate> createState() => _PainterValidateState();
}

class _PainterValidateState extends State<PainterValidate> {
  final CollectionReference collectionReference =
      FirebaseFirestore.instance.collection('PainterValidate');
