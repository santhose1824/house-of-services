...
import 'package:house_of_services/Pages/Users/Reviews/ReadPackerReview.dart';

class PackerList extends StatefulWidget {
  const PackerList({Key? key}) : super(key: key);

  @override
  State<PackerList> createState() => _PackerListState();
}

class _PackerListState extends State<PackerList> {
  final user = FirebaseAuth.instance.currentUser;
  final CollectionReference collectionReference =
      FirebaseFirestore.instance.collection('Packers');

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Goods Packer'),
        ),
