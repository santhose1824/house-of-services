...
class PackerReiviewPage extends StatefulWidget {
  const PackerReiviewPage({Key? key}) : super(key: key);

  @override
  State<PackerReiviewPage> createState() => _PackerReiviewPageState();
}

class _PackerReiviewPageState extends State<PackerReiviewPage> {
  final user = FirebaseAuth.instance.currentUser;
  CollectionReference collectionReference =
      FirebaseFirestore.instance.collection('PackerReview');
