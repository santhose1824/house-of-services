...
class PlumberValidate extends StatefulWidget {
  const PlumberValidate({Key? key}) : super(key: key);

  @override
  State<PlumberValidate> createState() => _PlumberValidateState();
}

class _PlumberValidateState extends State<PlumberValidate> {
  final CollectionReference collectionReference =
      FirebaseFirestore.instance.collection('PlumberValidate');
