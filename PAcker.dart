...
import 'package:house_of_services/Pages/Users/Painter.dart';
...
class PackerHomePage extends StatefulWidget {
  const PackerHomePage({Key? key}) : super(key: key);

  @override
  State<PackerHomePage> createState() => _PackerHomePageState();
}

class _PackerHomePageState extends State<PackerHomePage> {
  List<String> images = [
    'assets/_painter.jpg',
  ];
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => PackerList()));
              },
              child: Container(
                height: 500,
                width: 500,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Image(
                              image: AssetImage('assets/home-packers.jpg')),
                        ),
                      ],
                    ),
                  ),
